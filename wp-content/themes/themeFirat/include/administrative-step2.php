...
<form action="" method="POST" id="ss-form2">
    ...
    <label class="ss-q-title" for="entry_44">Major of study
        <span class="ss-required-asterisk">*</span></label>
    <input type="text" name="entry44single" value="<?php echo $_SESSION['entry44single']; ?>" class="ss-q-short" id="entry_44"><label class="ss-q-title" for="entry_46">Minor (if applicable)
    </label>
    <input type="text" name="entry46single" value="<?php echo $_SESSION['entry46single']; ?>" class="ss-q-short" id="entry_46"><label class="ss-q-title" for="entry_52">Major GPA
        <span class="ss-required-asterisk">*</span></label>
    <label class="ss-q-help" for="entry_52">On a 4.0 Scale</label>
    <input type="text" name="entry52single" value="<?php echo $_SESSION['entry52single']; ?>" class="ss-q-short" id="entry_52"><label class="ss-q-title" for="entry_65">Graduation date (Month/Year)
        <span class="ss-required-asterisk">*</span></label>
    ...
    <label class="ss-q-title" for="entry_171"># of Years Attended
        <span class="ss-required-asterisk">*</span></label>
    <label class="ss-q-help" for="entry_171"></label>
    <input type="text" name="entry171single" value="<?php echo $_SESSION['entry171single']; ?>" class="ss-q-short" id="entry_171"><h2 class="ss-section-title">College/University Attended</h2>
    <div class="ss-section-description ss-no-ignore-whitespace">(If you attended more than one school)</div>

    <label class="ss-q-title" for="entry_54">Name of college or university attended
    </label>
    <input type="text" name="entry54single" value="<?php echo $_SESSION['entry54single']; ?>" class="ss-q-short" id="entry_54"><label class="ss-q-title" for="entry_57">Degree type
    </label>
    <input type="text" name="entry57single" value="<?php echo $_SESSION['entry57single']; ?>" class="ss-q-short" id="entry_57"><label class="ss-q-title" for="entry_59">Major of study
    </label>

    <input type="text" name="entry59single" value="<?php echo $_SESSION['entry59single']; ?>" class="ss-q-short" id="entry_59"><label class="ss-q-title" for="entry_61">Minor (if applicable)
    </label>

    <input type="text" name="entry61single" value="<?php echo $_SESSION['entry61single']; ?>" class="ss-q-short" id="entry_61"><label class="ss-q-title" for="entry_63">Major GPA
    </label>
    <label class="ss-q-help" for="entry_63">On a 4.0 Scale</label>
    <input type="text" name="entry63single" value="<?php echo $_SESSION['entry63single']; ?>" class="ss-q-short" id="entry_63"><label class="ss-q-title" for="entry_50">Graduation date
    </label>
    ...
    <label class="ss-q-title" for="entry_173"># of Years Attended
    </label>
