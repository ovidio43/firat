...
<input type="text" name="entry.36.single" value="" class="ss-q-short" id="entry_36">

<label class="ss-q-title" for="entry_42">Degree type<span class="ss-required-asterisk">*</span></label>
<input type="text" name="entry.42.single" value="" class="ss-q-short" id="entry_42">

<label class="ss-q-title" for="entry_44">Major of study<span class="ss-required-asterisk">*</span></label>
<input type="text" name="entry.44.single" value="" class="ss-q-short" id="entry_44">

<label class="ss-q-title" for="entry_46">Minor (if applicable)</label>
<input type="text" name="entry.46.single" value="" class="ss-q-short" id="entry_46">

<label class="ss-q-title" for="entry_52">Major GPA<span class="ss-required-asterisk">*</span></label>
<label class="ss-q-help" for="entry_52">On a 4.0 Scale</label><input type="text" name="entry.52.single" value="" class="ss-q-short" id="entry_52">
...
<input type="text" name="entry.65.single" value="" class="ss-q-short" id="entry_65">

<label class="ss-q-title" for="entry_171"># of Years Attended<span class="ss-required-asterisk">*</span></label>
<label class="ss-q-help" for="entry_171"></label><input type="text" name="entry.171.single" value="" class="ss-q-short" id="entry_171">
...
<input type="text" name="entry.69.single" value="" class="ss-q-short" id="entry_69">
...
<input type="text" name="entry.54.single" value="" class="ss-q-short" id="entry_54">

<label class="ss-q-title" for="entry_57">Degree type</label>
<input type="text" name="entry.57.single" value="" class="ss-q-short" id="entry_57">

<label class="ss-q-title" for="entry_59">Major of study</label>
<input type="text" name="entry.59.single" value="" class="ss-q-short" id="entry_59">

<label class="ss-q-title" for="entry_61">Minor (if applicable)</label>
<input type="text" name="entry.61.single" value="" class="ss-q-short" id="entry_61">

<label class="ss-q-title" for="entry_63">Major GPA</label>
<label class="ss-q-help" for="entry_63">On a 4.0 Scale</label>
<input type="text" name="entry.63.single" value="" class="ss-q-short" id="entry_63">

<label class="ss-q-title" for="entry_50">Graduation date</label>
<label class="ss-q-help" for="entry_50">(Month/Year)</label>
<input type="text" name="entry.50.single" value="" class="ss-q-short" id="entry_50">

<label class="ss-q-title" for="entry_173"># of Years Attended</label>
<input type="text" name="entry.173.single" value="" class="ss-q-short" id="entry_173">
...
<input type="submit" name="continue" value="Continue &raquo;"></form>
