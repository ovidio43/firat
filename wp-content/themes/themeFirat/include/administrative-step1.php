...
<form action="" method="POST" id="ss-form1">
    ...
    <div class="content_block ">
        ...
        <div class="align_right ">
            <label class="ss-q-title" for="entry_175">Have you ever been convicted of a felony or subjected to deferred adjudication on a felony charge?
                <span class="ss-required-asterisk">*</span></label>
    ...
    <div class="content_block ">
        ...
        <label class="ss-q-title" for="entry_177">If yes, explain in concise detail, giving dates and nature of the offense, name and location of the court, and disposition of the case(s).  A conviction may not disqualify you, but a false statement will.
            <span class="ss-required-asterisk">*</span></label><label class="ss-q-help" for="entry_177">Answer &quot;NA&quot; if you answered &quot;No&quot; to the question above.</label>
    ...
    <div class="content_block ">
        <div class="full-block">
            <label class="ss-q-title" for="entry_179">Do you have a form of reliable transportation AND are insured?<span class="ss-required-asterisk">*</span></label>
    ...
    <div class="content_block ">
        <div class="align_left ">
            <label class="ss-q-title" for="entry_18">Mobile Number<span class="ss-required-asterisk">*</span></label><label class="ss-q-help" for="entry_18">(555) 555-5555</label>
            <input type="text" name="entry18single" value="<?php echo $_SESSION['entry18single']; ?>" class="ss-q-short" id="entry_18">
        </div>
        <div class="align_right ">
            <label class="ss-q-title" for="entry_22">Home Number</label><label class="ss-q-help" for="entry_22">(555) 555-5555</label>
    ...
    <div class="content_block ">
        <div class="full-block">
            <label class="ss-q-title" for="entry_242">What is your expected salary?<span class="ss-required-asterisk">*</span></label>
            <input type="text" name="entry242single" value="<?php echo $_SESSION['entry242single']; ?>" class="ss-q-short" id="entry_242">
        </div>
    </div>
