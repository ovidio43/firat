...
<div class="content_block ">
    ...
    </label><textarea name="entry181single" rows="8" cols="75" class="ss-q-long" id="entry_181"><?php echo $_SESSION['entry181single']; ?></textarea>
    </div>
</div>
...
<div class="content_block ">
    ...
    </label><textarea name="entry189single" rows="8" cols="75" class="ss-q-long" id="entry_189"><?php echo $_SESSION['entry189single']; ?></textarea>
    </div>
</div>
...
<div class="content_block ">
    ...
    <input type="text" name="entry157single" value="<?php echo $_SESSION['entry157single']; ?>" class="ss-q-short" id="entry_157">
    </div>
    <div class="align_right ">
    <label class="ss-q-title" for="entry_153">Company Phone Number</label>
    <label class="ss-q-help" for="entry_153">(555) 555-5555</label>
    <input type="text" name="entry153single" value="<?php echo $_SESSION['entry153single']; ?>" class="ss-q-short" id="entry_153">
    </div>
</div>
<div class="content_block ">
    <div class="align_left">
    ...
    <input type="text" name="entry225single" value="<?php echo $_SESSION['entry225single']; ?>" class="ss-q-short" id="entry_225">
    </div>
    <div class="align_right ">
    <label class="ss-q-title" for="entry_155">Name of Supervisor</label>
    <input type="text" name="entry155single" value="<?php echo $_SESSION['entry155single']; ?>" class="ss-q-short" id="entry_155">
    </div>
</div>
<div class="content_block ">
    <div class="align_left">
    ...
    <input type="text" name="entry151single" value="<?php echo $_SESSION['entry151single']; ?>" class="ss-q-short" id="entry_151">
    </div>
    <div class="align_right ">
    <label class="ss-q-title" for="entry_149">Job Title</label>
    <input type="text" name="entry149single" value="<?php echo $_SESSION['entry149single']; ?>" class="ss-q-short" id="entry_149">
    </div>
</div>
<div class="content_block ">
    <div class="full-block">
    ...
    <textarea name="entry140single" rows="8" cols="75" class="ss-q-long" id="entry_140"><?php echo $_SESSION['entry140single']; ?></textarea>
    </div>
</div>
<div class="content_block ">
    <div class="align_left">
...
<div class="content_block ">
    ...
    <textarea name="entry213single" rows="8" cols="75" class="ss-q-long" id="entry_213"><?php echo $_SESSION['entry213single']; ?></textarea>
    </div>
</div>
<div class="content_block ">
    <div class="align_left">
