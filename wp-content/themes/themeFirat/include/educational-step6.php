        ...
        <div class="full-block">
            ...
            <ul class="ss-choices">
                ...
                <li class="ss-choice-item">
                    <input type="checkbox" name="entry237group[]" value="__option__" class="ss-q-checkbox" id="other_option:237">
                    <label for="other_option:237">Other:</label>
    ...
    <div class="content_block ">
        <div class="full-block">
            ...
            <ul class="ss-choices">
                ...
                <li class="ss-choice-item">
                    <input type="checkbox" name="entry241group[]" value="__option__" class="ss-q-checkbox" id="other_option:241">
                    <label for="other_option:241">Other:</label>
                    <input type="text" name="entry241groupother_option_" value="" class="ss-q-other">
                </li>
