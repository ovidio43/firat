              ...
              <form id="formData" name="formData" action="<?php echo get_template_directory_uri();  ?>/sendmail.php">    
                    ...
                    <div class="content_block ">
                        ...
                        <p><b>Select the date of your practice test.</b> <span class="ss-required-asterisk">*</span> <br>
                         ...
                         <input type="radio" name="Help_on_every"  value="December 14, 2013"> <label for="Help_on_every">December 14, 2013</label><br>
                        <input type="radio" name="Help_on_every" value="January 11, 2014"> <label for="Help_on_every">January 11, 2014</label><br>
                        <input type="radio" name="Help_on_every" value="February 8, 2014"> <label for="Help_on_every">February 8, 2014</label><br>
                        <input type="radio" name="Help_on_every" value="March 8, 2014"><label for="Help_on_every"> March 8, 2014</label><br>
                        <input type="radio" name="Help_on_every" value="April 12, 2014"> <label for="Help_on_every">April 12, 2014</label><br>
                        <input type="radio" name="Help_on_every" value="May 10, 2014"> <label for="Help_on_every">May 10, 2014</label><br>
                        </div>
                    </div>
                    <div class="content_block ">
                        <div class="full-block ">
                    ...
                    <div class="content_block ">
                        ...
                        <p><b>Please tell us the date or dates you are planning on taking the OFFICIAL SAT or ACT.</b>  <span class="ss-required-asterisk">*</span> <br>
                            <span class="explain">Even if you have not yet registered, this information can help us when we analyze your practice test. Please check all that </span> 
                         </p>
                         <input type="checkbox" name="date_test[]" value="November SAT (11/02/13)"><label for="date_test">November SAT (11/02/13)</label><br>
                        <input type="checkbox" name="date_test[]" value="December SAT (12/07/13)"><label for="date_test">December SAT (12/07/13)</label><br>
                        <input type="checkbox" name="date_test[]" value="December ACT (12/14/13)"><label for="date_test">December ACT (12/14/13)</label><br>
                        <input type="checkbox" name="date_test[]" value="January SAT (01/25/14)"><label for="date_test">January SAT (01/25/14)</label><br>
                        <input type="checkbox" name="date_test[]" value="February ACT (02/08/14)"><label for="date_test">February ACT (02/08/14)</label><br>
                        <input type="checkbox" name="date_test[]" value="March SAT (03/08/14)"><label for="date_test">March SAT (03/08/14)</label><br>
                        <input type="checkbox" name="date_test[]" value="April ACT (04/12/14)"><label for="date_test">April ACT (04/12/14)</label><br>
                        <input type="checkbox" name="date_test[]" value="May SAT (05/03/14)"><label for="date_test">May SAT (05/03/14)</label><br>
                        <input type="checkbox" name="date_test[]" value="June SAT (06/07/14)"><label for="date_test">June SAT (06/07/14)</label><br>
                        <input type="checkbox" name="date_test[]" value="June ACT (06/14/14)"><label for="date_test">June ACT (06/14/14)</label><br>
                        <input type="checkbox" name="date_test[]" value="Not Applicable"><label for="date_test">Not Applicable. I am not taking the SAT or ACT</label><br>
                        </div>  
                    </div>   
                    <div class="content_block ">
                        <div class="full-block ">
