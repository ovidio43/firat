<?php
/*
 * Template name: educational form
 *
 */
$step = $_POST['step'];
get_header();
        ...
        <?php while (have_posts()) : the_post(); ?>
            ...
            <div class="entry-content">
                ...
                <!--div class="wrapform content-form backgroud_form">
                    <div class="wrap_date">
                        <?php if ($step == 1 || $step == "") { ?>
                            <div id="step-1"><?php require_once(get_template_directory() . '/include/educational-step1.php'); ?></div>
                        <?php } else if ($step == 2) { ?>
                            <div id="step-2"><?php require_once(get_template_directory() . '/include/educational-step2.php'); ?></div>
                        <?php } else if ($step == 3) { ?>
                            <div id="step-3"><?php require_once(get_template_directory() . '/include/educational-step3.php'); ?></div>
                        <?php } else if ($step == 4) { ?>
                            <div id="step-3"><?php require_once(get_template_directory() . '/include/educational-step4.php'); ?></div>
                        <?php } else if ($step == 5) { ?>
